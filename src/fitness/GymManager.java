...
public class GymManager {
    ...
    */
    ...
    private Member createMember(String [] temp){
        ...
        if(temp[3] == null) {
            temp[3] = "12/12/2028";
            Member tempMember = new Member(temp[0], temp[1], dobtemp, new Date(temp[3]),Location.NOVALUE);
            return tempMember;
        }
